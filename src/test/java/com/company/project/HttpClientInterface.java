...
public class HttpClientInterface {
     ...
     * @return
     */
    public static String doPost(String url, JSONObject json) throws JSONException {
        HttpClient httpClient = new HttpClient();
...
//        doPost("http://tcc.taobao.com/cc/json/mobile_tel_segment.htm?tel=13026194071", jsonObject);
        ...
        doGet("http://editest.byd.com.cn:28280/invoke/BYD_ICLOUD_ORDER/getToken?ueserNo=S140420&password=B82E819A", "UTF-8");
    }
}
